								...
								<nav class="dashboard-Navbar">
									...
									<ul class="submenu list-unstyled">
										...
										<li class="li-left indice-navegacion">
											<a href="<?php echo URL.'home/alumno';?>"><div class="op-navegador"><div class="navegadornombre">Inicio</div><div class="navegadorflecha"><i class="zmdi zmdi-chevron-right"></i></div></div></a>
										</li>
										<li class="li-left indice-navegacion">
                ...
                <div class="container mt-5" style="background-color: #f6f6f7;">
                    <div class="row" align="center">
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body mt-1">
                                    <a href="<?php echo URL.'perfil_alumno/datos_generales';?>" >
                        ...
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body mt-1">
                                    <a href="<?php echo URL.'perfil_alumno/contacto';?>">
                        ...
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body mt-1">
                                    <a href="<?php echo URL.'perfil_alumno/procedencia';?>">
                                        <img src="<?php echo URL;?>public/assets/img/procedencia.png" class="img-fluid" width="97" height="100" align="center">
                                        <p></p>
                                    </a>
                                    <h4 class="card-title mt-3">Procedencia</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body mt-1">
                                    <a href="<?php echo URL.'perfil_alumno/datos_adicionales';?>">
                                        <img src="<?php echo URL;?>public/assets/img/datos_ad.png" class="img-fluid" width="100" height="100" align="center">
                                        <p></p>
                                    </a>
                                    <h4 class="card-title mt-3">Datos adicionales</h4>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            ...
                            <div class="card">
                                <div class="card-body mt-1">
                                    <a href="<?php echo URL.'perfil_alumno/documentos';?>">
