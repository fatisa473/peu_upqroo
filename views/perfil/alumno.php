            ...
            <div class="row" id="navegacion" style="position: fixed; width: 100%; z-index: 1;">
                <div class="col-9">
                        <ol id="breadcrumb">
                            ...
                            <li class="menu-directorio-link"><a style="color: #fff; font-size:18px;" href="<?php echo URL.'home/alumno';?>">UPQROO</a></li>
                            <li class="menu-directorio text_resaltado" aria-current="page">PERFIL</li>
                        </ol>
                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Contacto y Servicio M.</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-3">
