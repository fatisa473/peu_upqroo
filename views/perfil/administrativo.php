			...
			<div class="dashboard-contentPage full-box">
                ...
                <div class="row" align="center">
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body mt-1">
                                <a href="<?Php echo URL; ?>perfil_administrativo/datos_generales" >
                    ...
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body mt-1">
                                <a href="<?Php echo URL; ?>perfil_administrativo/datos_laborales">
                    ...
                    <div class="col-sm-3">
                        <div class="card">
                            <div class="card-body mt-1">
                                <a href="<?Php echo URL; ?>perfil_administrativo/documentos">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div class="card">
                            <div class="card-body mt-1">
                                <a href="<?Php echo URL; ?>perfil_administrativo/buscador/Todos">
                                    <img src="<?php echo URL?>public/assets/img/documentos.png" class="img-fluid" width="100" height="100" align="center">
                                    <p></p>
                                </a>
                                <h4 class="card-title mt-3">Buscador</h4>
                            </div>
                        </div>
                    </div>
					<div class="col-sm-3">
                            ...
                            <div class="card">
                                <div class="card-body mt-1">
                                    <a href="<?php echo URL.'perfil_administrativo/cuenta';?>">
                                        <img src="<?php echo URL;?>public/assets/img/datos.png" class="img-fluid" width="100" height="100" align="center">
                                        <p></p>
                                    </a>
