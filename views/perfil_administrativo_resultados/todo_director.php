                    ...
                    <div class="col">                    
                        ...
                        <div class="row formcss">
                            ...
                            <div class="col-4 imageform">
                                <img class="rounded-circle z-depth-1-half avatar-pic image-fluid" src="<?php echo URL;?>public/assets/fotos/<?php echo $this->resultado_director['Imagen'];?>" width="200" alt="example placeholder avatar">
                            </div>
                            <div class="col-6">
                                <label>Carrera</label>
