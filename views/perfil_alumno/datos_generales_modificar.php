...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div class="row" id="navegacion" style="position: fixed; width: 100%; z-index: 1;">
                <div class="col-9">
                        <ol id="breadcrumb">
                            ...
                            <li class="menu-directorio-link"><a style="color: #fff; font-size:18px;" href="<?php echo URL.'perfil_alumno';?>">PERFIL</a></li>
            ...
            <br><br>
            <!-- Informacion - Inicio -->
            <form class="container" action="<?php echo URL;?>perfil_alumno/update_datos_generales" method="POST" enctype="multipart/form-data">
