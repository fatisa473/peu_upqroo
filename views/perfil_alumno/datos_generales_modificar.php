                ...
                <div class="pestaña-contenido">
					<section class="full-box">
						<div class="contenido">
                            ...
                            <form class="container mt-3" action="<?php echo URL;?>perfil_alumno/update_datos_generales" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_alumno/datos_generales" class="btn btn-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
            </form>
