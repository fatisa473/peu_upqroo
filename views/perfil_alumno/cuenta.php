	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
				...
				<!-- NavBar | Barra de navegación -->
								...
								<nav class="dashboard-Navbar">
									...
									<ul class="submenu list-unstyled">
										...
										<li class="li-left indice-navegacion">
											<a href="<?php echo URL.'perfil_alumno';?>"><div class="op-navegador"><div class="navegadornombre">Perfil</div><div class="navegadorflecha"><i class="zmdi zmdi-chevron-right"></i></div></div></a>
										</li>
										<li class="li-left indice-navegacion">
                ...
                <!-- Informacion - Inicio -->
                <form class="container mt-3" action="<?php echo URL;?>perfil_alumno/update_cuenta" method="POST" enctype="multipart/form-data">
				<input type="hidden" name="matricula" value="<?php echo $session->get("usuario");?>">
                ...
                <div class="row rowhite">
					...
					<div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_alumno/cuenta" class="btn btn-danger">Cancelar</a>
                        </div>
                </div>
            </form>
            <br>
