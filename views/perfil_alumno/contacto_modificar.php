	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
                ...
                <!-- Informacion - Inicio -->
                <form class="container mt-3" action="<?php echo URL;?>perfil_alumno/update_contacto" method="POST">
                ...
                <div class="row rowhite">
                    <div class="col">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_alumno/contacto" class="btn btn-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
            </form>
