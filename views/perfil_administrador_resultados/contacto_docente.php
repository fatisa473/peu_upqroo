                ...
                <div class="col-3" id="opc-breadcrum">
                    <ol id="breadcrumb" class="pt-1">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="<?php echo URL;?>perfil_administrador_resultados/docente_modificar/<?php echo $this->usuario.'/Contacto';?>"><i class="zmdi zmdi-edit zmdi-hc-fw"></i>Modificar</a>
                            </div>
