	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
                ...
                <!-- Informacion - Inicio -->
                <form class="container mt-3"  action="<?php echo URL;?>perfil_administrador_resultados/update_contacto_director" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        ...
                        <div class="row formcss">
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="direccion" required value="<?php echo $this->resultado_contacto['Domicilio']; ?>">
                            </div>
                            <div class="col-6">
                                <label>Telefono fijo</label>
                                <input type="text" class="form-control" minlength="10" maxlength="10" pattern="[0-9]+" required  name="contacto_tel_domi"
                                value="<?php echo $this->resultado_contacto['Tel_Domicilio']; ?>">
                            </div>
                            <div class="col-6">
                                <label>Celular</label>
                                <input type="text" class="form-control" minlength="10" maxlength="10" pattern="[0-9]+" required name="contacto_cel"
                                value="<?php echo $this->resultado_contacto['Celular']; ?>">
                            </div>
                            <div class="col-6">
                                <label>Nombre de emergencia</label>
                                <input type="text" class="form-control" name="nombre_emergencia" required value="<?php echo $this->resultado_contacto['Nombre_Emergencia']; ?>">
                            </div>
                            <div class="col-6">
                                <label>Numero de emergencia</label>
                                <input type="text" class="form-control" minlength="10" maxlength="10" pattern="[0-9]+" required  name="contacto_tel_eme"
                                 value="<?php echo $this->resultado_contacto['Tel_Emergencia']; ?>">
                            </div>
                            <div class="col-6">
                                <label>Empresa afiliada</label>
                                <input type="text" class="form-control" name="empresa_afiliada" required value="<?php echo $this->resultado_medico['Nombre']; ?>">
                            </div>
                            <div class="col-6">
                                <label>NSS</label>
                                <input type="text" class="form-control" name="nss" required value="<?php echo $this->resultado_medico['Num_Afiliacion']; ?>">
                            </div>
                            <div class="col-6">
                                    ...
                                    <select name="tipo_sangre" id="" class="form-control">
                                        <?php
                                            ...
                                            for ($i=0; $i < count($array_sangre); $i++) { 
                                                if($array_sangre[$i] == $rthis->esultado_medico['Tipo_Sangre']){
                                                    ?>
                                                        <option value="<?Php echo $array_sangre[$i]; ?>" selected><?Php echo $array_sangre[$i]; ?></option>
                                                    <?php
                                                }else{
                                                    ?>
                                    ...
                                    <select name="estatus" id="" class="form-control">
                                        <?php
                                            ...
                                            for ($i=0; $i < count($array_estatus); $i++) { 
                                                if($array_estatus[$i] == $this->resultado_medico['Estatus']){
                                                    ?>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_administrador_resultados/director/<?php echo $this->usuario."/Contacto";?>" class="btn btn-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
            </form>
