								...
								<nav class="dashboard-Navbar">
									...
									<ul class="submenu list-unstyled">
										...
										<li class="li-right">
											...
											<ul>
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/administrativo/<?php echo $this->usuario.'/Documentos';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Ver</div></a>
												</li>
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/administrativo_agregar/<?php echo $this->usuario.'/Documentos';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Agregar</div></a>
												</li>
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/administrativo_modificar/<?php echo $this->usuario.'/Documentos';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Modificar</div></a>
												</li>
											</ul>
										</li>
									</ul>
                ...
                <div class="row formcss">
                    ...
                    <?php
                        if($this->resultado_documentos)
                        {
                            ...
                            {
                                ?>
									<form action="<?php echo URL;?>perfil_administrador_resultados/delete_documento_administrativo" name="form<?php echo $i; ?>" method="POST" enctype="multipart/form-data">
										<input type="hidden" name="num_control" value="<?php echo $this->usuario; ?>">
										<input type="hidden" name="idDocumento" value="<?php echo $i;?>">
										<tr>
                                        <td>

											<input readOnly type="text" class="form-control" name="nomb_doc<?php echo $i;?>" id="" value="<?php echo  $this->resultado_documentos[$key]['documento'] ;?>">
                                        </td>
                                        <td>
											<input type="text" class="form-control" readOnly name="sel_tip<?php echo $i;?>" id="" value="<?php echo $this->resultado_documentos[$key]['tipo_documento'];?>">
                                        </td>
                                        <td>
											<input type="text" class="form-control" readOnly name="sel_tip<?php echo $i;?>" id="" value="<?php echo $this->resultado_documentos[$key]['Estatus'];?>">
                                        </td>
										<td>
											<input type="text" class="form-control" readOnly name="archivo<?php echo $i;?>" id="" value="<?php echo $this->resultado_documentos[$key]['Ruta'];?>">
                                        </td>
                                        <td>
											<button type="submit" class="btn-primary rounded">Eliminar</button>
                                        </td>
                                    </tr>
									</form>
