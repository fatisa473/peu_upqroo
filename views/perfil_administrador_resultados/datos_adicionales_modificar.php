                    ...
                    <div class="col">
                        ...
                        <div class="row formcss">
                                        ...
                                        <?php
                                            ...
                                            if($this->grupos_indigena){
                                                foreach($this->grupos_indigena as $i){
                                                    if($i['grupo'] == $this->resultado_grupo_indigena['Nombre']){
                                                        $lengua = $i['lengua'];
                                                        ?>
                                                            <option value="<?Php echo $i['ID_Indigena']."-".$i['lengua']; ?>" selected><?Php echo $i['grupo']; ?></option>
                                                        <?php
                                                    }else{
                                                        ?>
                            ...
                            <div class="col-6">
                                ...
                                <input type="text" class="form-control" name="lengua_indigena" id="lengua_indigena" readOnly value="<?php echo $this->resultado_lengua['Nombre'] ;?>">
                            </div>
                            <div class="col-6">
                                        ...
                                        <?php
                                            if($this->discapacidades){
                                                foreach($this->discapacidades as $i){
                                                    if($i['Nombre'] == $this->resultado_discapacidad['Nombre']){
                                                        ?>
                                                            <option value="<?Php echo $i['ID_Discapacidad']; ?>" selected><?Php echo $i['Nombre']; ?></option>
                                                        <?php
                                                    }else{
                                                        ?>
                                        ...
                                        <?php
                                            if($this->becas){
                                                foreach($this->becas as $i){
                                                    if($i['Nombre'] == $this->resultado_beca['Nombre']){
                                                        ?>
                                                            <option value="<?Php echo $i['ID_Beca']; ?>" selected><?Php echo $i['Nombre']; ?></option>
                                                        <?php
                                                    }else{
                                                        ?>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_administrador_resultados/alumno/<?php echo $this->usuario."/Adicionales";?>" class="btn btn-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
            </form>
