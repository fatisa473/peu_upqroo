	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
								...
								<nav class="dashboard-Navbar">
									...
									<ul class="submenu list-unstyled">
										...
										<li class="li-right">
											...
											<ul>
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/director_modificar/<?php echo $this->usuario.'/Documentos';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Editar</div></a>
												</li>
												<li>
                ...
                <!-- Informacion - Inicio -->
                <form class="container" action="<?php echo URL;?>perfil_administrador_resultados/insert_director_documentos" method="POST" enctype="multipart/form-data">
