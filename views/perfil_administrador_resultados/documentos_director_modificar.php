	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
								...
								<nav class="dashboard-Navbar">
									...
									<ul class="submenu list-unstyled">
										...
										<li class="li-right">
											...
											<ul>
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/director_agregar/<?php echo $this->usuario.'/Documentos';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Agregar</div></a>
												</li>
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/director_eliminar/<?php echo $this->usuario.'/Documentos';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Eliminar</div></a>
												</li>
											</ul>
										</li>
									</ul>
                ...
                <!-- Informacion - Inicio -->
                <form class="container" action="<?php echo URL;?>perfil_administrador_resultados/update_documentos_director" method="POST" enctype="multipart/form-data">
                        ...
                        if($this->resultado_documentos)
                        {
                            ...
                            foreach($this->resultado_documentos as $key => $value)
                            {
                                ?>
                                    <tr>
                                        <td>
											<input required type="text"class="form-control" name="nomb_doc<?php echo $i;?>" id="" value="<?php echo  $this->resultado_documentos[$key]['documento'] ;?>">
                                        </td>
                                        <td>
											<select name="sel_tip<?php echo $i;?>" id="" class="form-control">
											<?php
												if($this->resultado_tipo_documentos){
													foreach($this->resultado_tipo_documentos as $j){
														if($j['nombre_tipo_documento'] == $this->resultado_documentos[$key]['tipo_documento']){
															?>
															<option value="<?php echo $j['ID_Tipo_Doc'];?>" selected><?php echo $j['nombre_tipo_documento']; ?> </option>
															<?php
														}else{
															?>
															<option value="<?php echo $j['ID_Tipo_Doc'];?>"><?php echo $j['nombre_tipo_documento']; ?> </option>
															<?php
														}
													}
												}
                                        ...
                                        <td>
											<select name="sel_est<?php echo $i;?>" id="" class="form-control">
											<?php
												$array_estatus = array("Correcto","Incorrecto");
												for ($j=0; $j < count($array_estatus); $j++) {
													if($array_estatus[$j] == $this->resultado_documentos[$key]['Estatus'])
													{
														?>
														<option value="<?php echo $array_estatus[$j];?>" selected> <?php echo $array_estatus[$j];?> </option>
														<?php
													}else{
														?>
														<option value="<?php echo $array_estatus[$j];?>"> <?php echo $array_estatus[$j];?> </option>
														<?php
													}
												}
											?>
                                        ...
                                        <td>
										<input type="file" required class="btn-primary rounded"  accept=".pdf" name="archivo<?php echo $i;?>" >
                                        </td>
                                    </tr>
                                <?php
								$i++;
                ...
                <br>
						<div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_administrador_resultados/director/<?php echo $this->usuario."/Documentos";?>" class="btn btn-danger">Cancelar</a>
                        </div> 
            </form>
            <br>
                <!-- Informacion - Fin -->
