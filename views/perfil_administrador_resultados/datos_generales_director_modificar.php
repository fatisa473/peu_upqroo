                ...
                <div class="row rowhite">
                    <div class="col">
                            ...
                            <div class="col-8">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" name="num_control" disabled value="<?php echo $this->resultado_director['Num_Control'];?>">
                                    </div>
                                    <div class=" col-6">
                                        <label>Nombre</label>
                                        <input type="text" class="form-control" name="nombres" required value="<?php echo $this->resultado_director['Nombres'];?>">
                                    </div>
                                    <div class="col-6">
                                        <label>Apellido paterno</label>
                                        <input type="text" class="form-control" name="ap_P" required value="<?php echo $this->resultado_director['Apellido_paterno'];?>">
                                    </div>
                                    <div class="col-6">
                                        <label>Apellido materno</label>
                                        <input type="text" class="form-control" name="ap_M" required value="<?php echo $this->resultado_director['Apellido_materno']?>">
                                    </div>
                                    <div class="col-6">
                                        <label>Carrera</label>
                                    ...
                                    <?php
                                        if($this->periodos){
                                            foreach($this->periodos as $i){
                                                if($i['Descripcion'] == $this->resultado_descripcion_periodo['Descripcion'] && $i['Anio'] == $this->resultado_id_descripcion_periodo['Anio']){
                                                    ?>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_administrador_resultados/director/<?php echo $this->usuario."/Generales";?>" class="btn btn-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
            </form>
