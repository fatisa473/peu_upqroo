	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
                ...
                <!-- Informacion - Inicio -->
                <form class="container mt-3"  action="<?php echo URL;?>perfil_administrador_resultados/update_cuenta_director" method="POST" enctype="multipart/form-data">
                ...
                <div class="row rowhite">
                    <div class="col">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_administrador_resultados/director/<?php echo $this->usuario;?>/Cuenta" class="btn btn-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
            </form>
