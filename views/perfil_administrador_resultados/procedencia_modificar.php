	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
                ...
                <form class="container mt-3" action="<?php echo URL;?>perfil_administrador_resultados/update_procedencia" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        ...
                        <div class="row formcss">
                                        ...
                                        <?php
                                            if($this->bachilleres){
                                                foreach($this->bachilleres as $i){
                                                    if($i['Nombre'] == $this->resultado_bachiller['Nombre']){
                                                        ?>
                                                            <option value="<?Php echo $i['ID_Bachiller']; ?>" selected><?Php echo $i['Nombre']; ?></option>
                                                        <?php
                                                    }else{
                                                        ?>
                                        ...
                                        <?php
                                            if($this->areas_bachilleres){
                                                foreach($this->areas_bachilleres as $i){
                                                    if($i['Nombre'] == $this->resultado_bachiller_area['Nombre']){
                                                        ?>
                                                            <option value="<?Php echo $i['ID_Bach_Area']; ?>" selected><?Php echo $i['Nombre']; ?></option>
                                                        <?php
                                                    }else{
                                                        ?>
                            ...
                            <div class="col-6">
                                ...
                                <input type="number" class="form-control"  name="general" value="<?php echo $this->resultado_procedencia['Prom_Gral'] ;?>">
                            </div>
                            <div class="col-6">
                                <label>Promedio exani II</label>
                                <input type="number" class="form-control" name="exani" value="<?php echo $this->resultado_procedencia['Prom_Exani_2'] ;?>">
                            </div>
                            <div class="col-6">
                                <label>Promedio egel</label>
                                <input type="number" class="form-control" name="egel" value="<?php echo $this->resultado_procedencia['Prom_EGEL'] ;?>">
                            </div>
                            <div class="col-6">
                                <label>Promedio toefl</label>
                                <input type="number" class="form-control" name="toeftl" value="<?php echo $this->resultado_procedencia['Prom_TOEFL'] ;?>">
                            </div>
                            <div class="col-6">
                                <label>Fecha de egreso</label>
                                <input type="date" class="form-control" name="fecha_egreso" value="<?php echo $this->resultado_procedencia['Fecha_egreso'] ;?>">
                            </div>
                        </div>
                        <br>
                        <div class="form-group mt-3">
                            <button type="submit" class="btn btn-primary" name="contacto">Guardar</button>
                            <a href="<?php echo URL;?>perfil_administrador_resultados/alumno/<?php echo $this->usuario."/Procedencia";?>" class="btn btn-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
            </form>
