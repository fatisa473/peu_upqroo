	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
                ...
                <!-- Informacion - Inicio -->                
                <form class="container mt-3"  action="<?php echo URL;?>perfil_administrador_resultados/update_administrativo_general" method="POST" enctype="multipart/form-data">
                ...
                <div class="row rowhite">
                    <div class="col">
                            ...
                            <div class="col-8">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" name="num_control" readOnly value="<?php echo $this->resultado_administrativo['Num_Control'] ;?>">
                                    </div>
                                    <div class="form-group2 col-6">
                                        <label>Nombre</label>
                                        <input type="text" class="form-control" name="nombres" required value="<?php echo $this->resultado_administrativo['Nombres'] ;?>">
                                    </div>
                                    <div class="col-6">
                                        <label>Apellido paterno</label>
                                        <input type="text" class="form-control" name="ap_P" required value="<?php echo $this->resultado_administrativo['Apellido_paterno'] ;?>">
                                    </div>
                                    <div class="col-6">
                                        <label>Apellido materno</label>
                                        <input type="text" class="form-control" name="ap_M" required value="<?php echo $this->resultado_administrativo['Apellido_materno'] ;?>">
                                    </div>
                                    <div class="col-6">
                                        <label>Carrera</label>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_administrador_resultados/administrativo/<?php echo $this->usuario."/Generales";?>" class="btn btn-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
            </form>
