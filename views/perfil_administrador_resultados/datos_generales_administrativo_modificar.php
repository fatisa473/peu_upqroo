                            ...
                            <div class="col-8">
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" name="num_control" value="<?php echo $this->resultado_administrativo['Num_Control'] ;?>">
                                    </div>
                                    <div class="form-group2 col-6">
                                        <label>Nombre</label>
                                        <input type="text" class="form-control" name="nombres" value="<?php echo $this->resultado_administrativo['Nombres'] ;?>">
                                    </div>
                                    <div class="col-6">
                                        <label>Apellido paterno</label>
                                        <input type="text" class="form-control" name="ap_P" value="<?php echo $this->resultado_administrativo['Apellido_paterno'] ;?>">
                                    </div>
                                    <div class="col-6">
                                        <label>Apellido materno</label>
                                        <input type="text" class="form-control" name="ap_M" value="<?php echo $this->resultado_administrativo['Apellido_materno'] ;?>">
                                    </div>
                                    <div class="col-6">
                                        <label>Carrera</label>
