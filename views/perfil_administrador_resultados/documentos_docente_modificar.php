	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
								...
								<nav class="dashboard-Navbar">
									...
									<ul class="submenu list-unstyled">
										...
										<li class="li-right">
											...
											<ul>
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/docente_agregar/<?php echo $this->usuario.'/Documentos';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Agregar</div></a>
												</li>
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/docente_eliminar/<?php echo $this->usuario.'/Documentos';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Eliminar</div></a>
												</li>
											</ul>
										</li>
									</ul>
                ...
                <!-- Informacion - Inicio -->
                <form class="container" action="<?php echo URL;?>perfil_administrador_resultados/update_documentos_docente" method="POST" enctype="multipart/form-data">
                ...
                <br>
						<div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_administrador_resultados/docente/<?php echo $this->usuario."/Documentos";?>" class="btn btn-danger">Cancelar</a>
                        </div> 
            </form>
            <br>
                <!-- Informacion - Fin -->
