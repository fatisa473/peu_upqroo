								...
								<nav class="dashboard-Navbar">
									...
									<ul class="submenu list-unstyled">
										...
										<li class="li-right">
											...
											<ul>
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/director/<?php echo $this->usuario.'/Documentos';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Ver</div></a>
												</li>
												<li>
												...
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/director_modificar/<?php echo $this->usuario.'/Documentos';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Modificar</div></a>
												</li>
											</ul>
										</li>
									</ul>
                ...
                <div class="row formcss">
                    ...
                    <?php
                        if($this->resultado_documentos)
                        {
                            ...
                            {
                                ?>
									<form action="<?php echo URL;?>perfil_administrador_resultados/delete_documento_director" name="form<?php echo $i; ?>" method="POST" enctype="multipart/form-data">
