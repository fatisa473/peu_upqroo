	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
                ...
                <!-- Informacion - Inicio -->                
                <form class="container mt-3"  action="<?php echo URL;?>perfil_administrador_resultados/update_laboral_docente" method="POST" enctype="multipart/form-data">
                ...
                <div class="row rowhite">
                    <div class="col">
                                    ...
                                    <?php
                                        if($this->puestos){
                                            foreach($this->puestos as $i){
                                                if($i['Nombre'] == $this->resultado_puesto['Nombre']){
                                                    ?>
                                                        <option value="<?Php echo $i['ID_Puesto']; ?>" selected><?Php echo $i['Nombre']; ?></option>
                                                    <?php
                                                }else{
                                                    ?>
                                    ...
                                    <?php
                                        if($this->areasAcademicas){
                                            foreach($this->areasAcademicas as $i){
                                                if($i['Nombre'] == $this->resultado_area['Nombre']){
                                                    ?>
                                                        <option value="<?Php echo $i['ID_Area']; ?>" selected><?Php echo $i['Nombre']; ?></option>
                                                    <?php
                                                }else{
                                                    ?>
                                    ...
                                    <?php
                                        if($this->departamentos){
                                            foreach($this->departamentos as $i){
                                                if($i['Nombre'] == $this->resultado_departamento['Nombre']){
                                                    ?>
                                                        <option value="<?Php echo $i['ID_Departamento']; ?>" selected><?Php echo $i['Nombre']; ?></option>
                                                    <?php
                                                }else{
                                                    ?>
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_administrador_resultados/docente/<?php echo $this->usuario."/Laborales";?>" class="btn btn-danger">Cancelar</a>
                        </div> 
                    </div>
                </div>
            </form>
