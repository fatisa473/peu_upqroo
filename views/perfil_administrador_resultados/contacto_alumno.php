								...
								<nav class="dashboard-Navbar">
									...
									<ul class="submenu list-unstyled">
										...
										<li class="li-right">
                                            ...
                                            <ul>
												<li>
													<a href="<?php echo URL;?>perfil_administrador_resultados/alumno_modificar/<?php echo $this->usuario.'/Contacto';?>"><div class=espacio><i class="zmdi zmdi-edit"></i> Editar</div></a>
												</li>
											</ul>
										</li>
									</ul>
