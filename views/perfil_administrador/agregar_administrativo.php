            ...
            <form class="container">
                ...
                <div class="row rowhite">
                    <div class="col">                    
                        ...
                        <div class="row">
                            <div class="col">
                                <p style="font-size:18px; font-weight:bold;">Datos del administrativo</p>
                                <hr>
                            </div>
                        </div>
                        ...
                        <div class="row formcss">      
                            ...
                            <div class="col-6">
                                <label>Perfil</label>
                                <input type="text" name="" id="" readonly="readonly" value="Administrativo" class="form-control" style="background: white;">
                            </div>
                        </div>   
                        <br>                                                    
                        <!-- DOCUMENTOS -->
