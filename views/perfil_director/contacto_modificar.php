...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <br><br>
            <!-- Informacion - Inicio -->
            <form class="container" action="<?php echo URL;?>perfil_director/update_contacto" method="POST">
                ...
                <div class="row rowhite">
                    <div class="col">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_director/contacto" class="btn btn-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
