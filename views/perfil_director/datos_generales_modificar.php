    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            <ul class="list-unstyled components" style="position: fixed;">
                <br><br> <br>
                <li>
                    <a href="<?php echo URL.'perfil_director';?>"><i class="zmdi zmdi-account-circle zmdi-hc-lg zmdi-hc-fw"></i>Perfil</a>
                </li>
                <li>
        ...
        <div class="content">
            ...
            <div class="row" id="navegacion" style="position: fixed; width: 100%; z-index: 1;">
                <div class="col-9">
                        <ol id="breadcrumb">
                            ...
                            <li class="menu-directorio-link"><a style="color: #fff; font-size:18px;" href="<?php echo URL.'home/director';?>">UPQROO</a></li>
                            <li class="menu-directorio-link"><a style="color: #fff; font-size:18px;" href="<?php echo URL.'perfil_director';?>">PERFIL</a></li>
            ...
            <br><br>
            <!-- Informacion - Inicio -->
            <form class="container" action="<?php echo URL;?>perfil_director/update_datos_generales" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col">
                        ...
                        <div class="row formcss">
                            ...
                            <div class="col-4 imageform">
                                ...
                                <div>
                                    <input type="button" class="btn-primary rounded" name="imagen" onclick="type='file'"
                                        accept="image/jpeg,image/jpg,image/png" value="Seleccionar">
                                </div>
                            </div>
                            <div class="col-6">
                                <label>Pais</label>
                        ...
                        <div class="form-group mt-3">
                            <button type="submit" class="btn btn-primary" name="inf_docente">Guardar</button>
                            <a href="<?php echo URL;?>perfil_director/datos_generales" class="btn btn-danger">Cancelar</a>
                        </div>
                    </div>
                </div>
            </form>
