	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
								...
								<nav class="dashboard-Navbar">
									...
									<ul class="submenu list-unstyled">
										...
										<li class="li-left indice-navegacion">
											<a href="<?php echo URL.'home/director';?>"><div class="op-navegador"><div class="navegadornombre">Inicio</div><div class="navegadorflecha"><i class="zmdi zmdi-chevron-right"></i></div></div></a>
										</li>
										<li class="li-left indice-navegacion">
                ...
                <!-- Informacion - Inicio -->                
                <form class="container mt-3" action="<?php echo URL;?>perfil_director/update_datos_generales" method="POST" enctype="multipart/form-data">
