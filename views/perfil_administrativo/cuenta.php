	...
	<section class="seccionmaster">
		<div class="contenedormaster">
			...
			<div class="dashboard-contentPage full-box">
                ...
                <!-- Informacion - Inicio -->
                <form class="container mt-3" action="<?php echo URL;?>perfil_administrativo/update_cuenta" method="POST" enctype="multipart/form-data">
                ...
                <div class="row rowhite">
					...
					<div class="form-group mt-3">
                            ...
                            <a href="<?php echo URL;?>perfil_administrativo/cuenta" class="btn btn-danger">Cancelar</a>
                        </div>
                </div>
            </form>
            <br>
